...
class QuickRDFConverter:
    """
    This small scripts converts ontologies from one format syntax into another, e.g., from XML to Turtle.
    """
    @staticmethod
    def convert(in_file, out_file, in_syntax=None, out_syntax='ttl'):
        g = Graph()
